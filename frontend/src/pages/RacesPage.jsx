...
export default function RacesPage() {
  ...
  return (
    <div className="page-enter">
      <h1 style={styles.pageTitle}>Analisi Gare - Stagione {CURRENT_SEASON}</h1>
      {error && <div className="error-msg">{error}</div>}

      {selected && (
        loadingRes ? <div className="spinner" /> : <RaceDetail race={selected} results={results} />
      )}

      <div className="card" style={{ marginBottom: 20 }}>
        <h3 style={styles.sectionTitle}>Calendario & Risultati {CURRENT_SEASON}</h3>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
        ...
        <div className="card">
          <h3 style={styles.sectionTitle}>Statistiche Stagione {CURRENT_SEASON}</h3>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
            {[
